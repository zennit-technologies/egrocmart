        ...
        <div class="container-fluid">
            <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
                <div class="section_title d-flex mb-3 align-items-baseline border-bottom">
                    <h2><span class="border-bottom border-primary border-width-2 pb-3 d-inline-block"><?php echo e($s->title); ?></span></h2>
                    <div class="pop_desc_title">
                        <?php if(isset($s->slug) && $s->slug != ""): ?>
                        <a href="<?php echo e(route('shop', ['section' => $s->slug])); ?>" class="view title-section view-all ml-auto mr-0 btn btn-primary btn-sm shadow-md w-100 w-md-auto"><?php echo e(__('msg.view_all')); ?>&nbsp;&nbsp;<i class="fas fa-long-arrow-alt-right"></i></a>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="row ">
                            ...
                            <div class="product_items">
                                <article class="single_product">
                                    <figure>
                                        ...
                                        <figcaption class="product_content">
                                            <h4 class="product_name"><a href="<?php echo e(route('product-single', $p->slug)); ?>"><?php if(strlen(strip_tags($p->name)) > 25): ?> <?php echo substr(strip_tags($p->name), 0,25)."..."; ?> <?php else: ?> <?php echo substr(strip_tags($p->name), 0,25); ?> <?php endif; ?></a>
                                            </h4>
                                ...
                                <article class="single_product">
                                    <figure>
                                        ...
                                        <figcaption class="product_content">
                                            <h4 class="product_name"><a href="<?php echo e(route('product-single', $p->slug)); ?>"><?php if(strlen(strip_tags($p->name)) > 25): ?> <?php echo substr(strip_tags($p->name), 0,25)."..."; ?> <?php else: ?> <?php echo substr(strip_tags($p->name), 0,25); ?> <?php endif; ?></a></h4>
                                            </h4>
                                            <div class="action_links">
                                                <span class="inner product_data">
                                                    <ul>
...
<?php endif; ?>
<?php /**PATH /home2/zennit/public_html/web.grocery/resources/views/themes/eCart/parts/style_3.blade.php ENDPATH**/ ?>